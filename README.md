...
When scrolling, the section being displayed is detected and the corresponding menu section lights up. This is done by manipulating the DOM with Javascript using appendChild, classList, querSelector and event handling with addEventListener.
